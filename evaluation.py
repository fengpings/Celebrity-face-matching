...
def evaluation(pred, gt_path,save_path='./',iou_thresh=0.5):
    ...
    for setting_id in range(3):
        ...
        pr_curve = dataset_pr_info(len(pr_curve), pr_curve, count_face)
        np.save(os.path.join(save_path,'pr_curve'+str(setting_id)),pr_curve)
    ...
    print("=================================================")
    np.save(os.path.join(save_path,'aps'),aps)
    return aps,pr_curve
